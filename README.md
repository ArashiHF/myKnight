# myKnight
 Knight Dream是我的毕业设计，该项目参考了许多UE插件和unity博主的项目，如果是想看《艾莉冒险》的话，因为项目属于工作室并且处于停止开发（就是砍了）阶段，在协议上不能公开使用，但艾莉冒险跟本项目使用相似的设计逻辑，UI方面为本项目的优化版，动作部分采用了playerController项目中的设计，相当于平替。  
